...
public class JavaBank extends JFrame {
    ...
    private void createUserInterface() {
        ...
        inputDetailJPanel.setBounds(16, 16, 208, 290);
        ...
        scrollPane.setBounds(240,48,402,300); //Изменен размер поля вывода
        ...
        setSize(670, 400); // set window size   //Изменен размер окна
    ...
    private void CreateAccountJButtonActionPerformed(ActionEvent event){
        ...
        if ((noAccounts <= 9) & (Name != "") & (Accountnum != 0)) {
            ...
            displayAccountDetails(myAccounts);
            noAccounts ++;
    ...
    private void TransactionJButtonActionPerformed(ActionEvent event) {
        ...
        if (noAccounts == 0) {
            ...
            try {
                Accountnum = Integer.parseInt(AccountnumJTextField.getText());
                if (Integer.parseInt(DepositJTextField.getText()) < 0) {
                ...
                if (Integer.parseInt(WithdrawJTextField.getText()) < 0) {
    ...
    private void displayAccountDetails(AbstractBankAccount account[]){
        ...
        for (int i=0; i<noAccounts; i++) {
            ...
            displayJTextArea.setText(displayJTextArea.getText() +  account[i].toString());
